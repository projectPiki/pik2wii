...
////////////////////////////////////////////////////////
/////////// SCENE-DEPENDENT MATRIX FUNCTIONS ///////////
////////////////////////////////////////////////////////
...
/**
 * @brief Flags to indicate which components require reload.
 */
enum InvalidateFlag {
	INVALIDATE_SYNCGX  = 0,
	INVALIDATE_TEX     = (1 << 0),
	...
	INVALIDATE_ALL = INVALIDATE_TEX | INVALIDATE_TLUT | INVALIDATE_TEV | INVALIDATE_GENMODE | INVALIDATE_SHP | INVALIDATE_CURRMTX
	               | INVALIDATE_TEXMTX | INVALIDATE_MISC | INVALIDATE_FOG | INVALIDATE_LIGHT | INVALIDATE_POSMTX
};

/**
 * @brief Source types for scene-dependent texture matrix functions.
 */
...
////////////////////////////////////////////////////////
///////////// INDIRECT TEXTURE MATRIX INFO /////////////
////////////////////////////////////////////////////////

/**
 * @brief Data object for handling indirect texture matrix data and flags.
 *
 * @note Size: 0x94.
 */
struct IndTexMtxInfo {
	...
	u32 flag;                                        // _00
	math::MTX34 offset_mtx[GX_ITM_2 - GX_ITM_0 + 1]; // _04
};

////////////////////////////////////////////////////////
////////////// INDIRECT MATRIX OPERATIONS //////////////
////////////////////////////////////////////////////////

/**
 * @brief Abstract base class for operating on indirect texture matrices.
 *
 * @note Size: 0x4.
 */
class IndMtxOp {
public:
	virtual void operator()(IndTexMtxInfo* pInfo) = 0; // _08
	virtual ~IndMtxOp() { }                            // _0C
	virtual void Reset() = 0;                          // _10
	virtual void SetNrmMapMtx(GXIndTexMtxID id, const math::VEC3* pLightVec, const math::MTX34* pNrmMtx,
...
////////////////////////////////////////////////////////
///////// INDIRECT MATRIX OPERATION (STANDARD) /////////
////////////////////////////////////////////////////////

/**
 * @brief Standard implementation of IndMtxOp for operating on indirect texture matrices.
 *
 * @note Size: 0x98.
 */
...
public:
	...
	virtual void operator()(IndTexMtxInfo* pInfo); // _08
	virtual ~IndMtxOpStd() { }                     // _0C
	virtual void Reset();                          // _10
	virtual void SetNrmMapMtx(GXIndTexMtxID id, const math::VEC3* pLightVec, const math::MTX34* pNrmMtx,
	                          ResMatMiscData::IndirectMethod method); // _14

private:
	// _00     = VTBL
	// _00-_04 = IndMtxOp
	bool mIsValidMtx[GX_ITM_2 - GX_ITM_0 + 1];    // _04
	u8 PADDING_0x7;                               // _07
	math::MTX34 mIndMtx[GX_ITM_2 - GX_ITM_0 + 1]; // _08
};
...
void LoadResMatChan(const ResMatChan chan, u32 maskDiffColor, u32 maskDiffAlpha, u32 maskSpecColor, u32 maskSpecAlpha, GXColor amb,
                    bool lightOff);
...
void SetViewPosNrmMtxArray(const math::MTX34* pViewPosMtxArray, const math::MTX33* pViewNrmMtxArray,
...
void LoadLightSet(int id, u32* pDiffColorMask, u32* pDiffAlphaMask, u32* pSpecColorMask, u32* pSpecAlphaMask, AmbLightObj* pAmb);
