 ...
 * @note Size: 0x8
 */
int TCamera::JSGGetProjectionType() const
{
	return 1;
}
 ...
 * @note Size: 0x8
 */
f32 TCamera::JSGGetProjectionNear() const
{
	return 0.0f;
}
 ...
 * @note Size: 0xC
 */
f32 TCamera::JSGGetProjectionFar() const
{
	return FLT_MAX;
}
 ...
 * @note Size: 0x8
 */
f32 TCamera::JSGGetProjectionFovy() const
{
	return 0.0f;
}
 ...
 * @note Size: 0x8
 */
f32 TCamera::JSGGetProjectionAspect() const
{
	return 0.0f;
}
 ...
 * @note Size: 0x8
 */
int TCamera::JSGGetViewType() const
{
	return 1;
}
 ...
 * @note Size: 0x8
 */
f32 TCamera::JSGGetViewRoll() const
{
	return 0.0f;
}
