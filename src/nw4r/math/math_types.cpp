 ...
 * NON-MATCHING
 */
MTX34* MTX34RotXYZFIdx(register MTX34* pMtx, register f32 x, register f32 y, register f32 z)
{
	f32 array[2]                             = { 65536, 65536 };
	register f32* pArray                     = array;
	register detail::SinCosSample* sinCosTbl = (detail::SinCosSample*)detail::gSinCosTbl;
