 ...
 *
 */
bool ResTev::GXGetTevSwapModeTable(GXTevSwapSel swap, GXTevColorChan* pR, GXTevColorChan* pG, GXTevColorChan* pB, GXTevColorChan* pA) const
{
 ...
 *
 */
void ResTev::GXSetTevSwapModeTable(GXTevSwapSel swap, GXTevColorChan r, GXTevColorChan g, GXTevColorChan b, GXTevColorChan a)
{
...
void ResTev::CallDisplayList(bool sync) const
{
	...
	static const u32 dlsize[GX_MAXTEVSTAGE] = { ROUND_UP(sizeof(ResTevCommonDL) + 1 * sizeof(ResTevVariableDL), 32),
