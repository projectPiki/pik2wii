...
// @TODO: Adjust (unused) GX calls to use our style
...
void ResShp::GXSetArray(GXAttr attr, const void* pBase, u8 stride)
{
	...
	detail::ResWriteCPCmd(&pCmd[GX_CP_CMD_SZ * 0], cpAttr + GX_CP_REG_ARRAYBASE, (OSCachedToPhysical(pBase)));
